...
public class NerdLauncherFragment extends Fragment {
    ...
    private class ActivityHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        public ActivityHolder(LayoutInflater inflater, ViewGroup parent) {
            super(inflater.inflate(R.layout.recycler_view_layout, parent, false));
            mNameTextView = (TextView) itemView.findViewById(R.id.app_text_view);
            mImageView = (ImageView) itemView.findViewById(R.id.app_image_view);
